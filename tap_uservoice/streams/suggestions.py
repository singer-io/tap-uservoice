...
class SuggestionsStream(BaseStream):
    ...
    SCHEMA = with_properties(merge(
        ...
        make_date_field('jira_status_last_updated_at'),
        {
            ...
            "state": {"type": "string"},
            "supporter_mrr": {"type": "integer"},
            "supporter_satisfaction_score": {"type": "integer"},
            ...
            "links": {
                ...
                "properties": {
                    ...
                    "jira_issues": {"type": ["integer", "null"]},
                    "labels": {"type": ["integer", "null"]},
